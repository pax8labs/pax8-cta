...
test.describe("Claude Code Skill Integration", () => {
  ...
  test("should list deployments with filtering (skill workflow: show failed deployments)", async ({
    request,
  }) => {
  ...
  test("should get deployment details (skill workflow: check deployment status)", async ({
    request,
  }) => {
  ...
  test("should download solution file for deployment (skill workflow: create deployment)", async ({
    request,
  }) => {
