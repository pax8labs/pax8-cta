            ...
            <ThemeProvider>
              ...
              <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <nav className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700" aria-label="Main navigation">
                  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                      <a href="/" className="flex items-center gap-2 sm:gap-3" aria-label="AgentSync Home">
                        <Image
                ...
                <div className="flex flex-1">
                  <main id="main-content" className="flex-1 max-w-7xl w-full mx-auto py-6 px-4 sm:px-6 lg:px-8 overflow-y-auto">
                    <ErrorBoundary>
                      {children}
                    </ErrorBoundary>
                  </main>
