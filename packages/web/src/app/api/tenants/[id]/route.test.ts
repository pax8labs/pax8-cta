...
describe('GET /api/tenants/[id]', () => {
  ...
  it('should require authentication and tenant access', async () => {
    ...
    const request = new NextRequest('http://localhost/api/tenants/11111111-1111-1111-1111-111111111111')
    const response = await GET(request, { params })

    expect(response.status).toBe(403)
    expect(vi.mocked(requireTenantAccess)).toHaveBeenCalledWith('11111111-1111-1111-1111-111111111111')
  })
  ...
  it('should return empty deployed agents array for tenant with no agents', async () => {
    ...
    const request = new NextRequest('http://localhost/api/tenants/22222222-2222-2222-2222-222222222222')
    const response = await GET(request, { params })
    const data = await response.json()
