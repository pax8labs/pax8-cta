...
describe('DELETE /api/agents/[id]', () => {
  ...
  it('should prevent deletion of built-in agents', async () => {
    ...
    const request = new NextRequest('http://localhost/api/agents/built_in_hr_agent', { method: 'DELETE' })
    const response = await DELETE(request, { params })
    const data = await response.json()
  ...
  it('should return 404 for non-existent custom agent', async () => {
    ...
    const request = new NextRequest('http://localhost/api/agents/nonexistent_agent', { method: 'DELETE' })
    const response = await DELETE(request, { params })
    const data = await response.json()
  ...
  it('should successfully delete custom agent', async () => {
    ...
    const request = new NextRequest('http://localhost/api/agents/custom_agent_1', { method: 'DELETE' })
    const response = await DELETE(request, { params })
    const data = await response.json()
  ...
  it('should remove agent from store after deletion', async () => {
    ...
    const request = new NextRequest('http://localhost/api/agents/custom_agent_2', { method: 'DELETE' })
  ...
  it('should handle multiple deletions correctly', async () => {
    ...
    const request1 = new NextRequest('http://localhost/api/agents/custom_agent_1', { method: 'DELETE' })
    ...
    const request2 = new NextRequest('http://localhost/api/agents/custom_agent_2', { method: 'DELETE' })
  ...
  it('should not delete already deleted agent', async () => {
    ...
    const request2 = new NextRequest('http://localhost/api/agents/custom_agent_1', { method: 'DELETE' })
