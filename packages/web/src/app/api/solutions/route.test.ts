...
describe('GET /api/solutions', () => {
  ...
  it('should filter system solutions in non-demo mode', async () => {
    const { isDemoMode, loadConfig, getClientSecret, DataverseClient, SolutionOperations } = await import('@agentsync/core')
    ...
    const mockListSolutions = vi.fn().mockResolvedValue([
      { solutionid: 'sol-1', uniquename: 'CustomAgent', friendlyname: 'Custom Agent', version: '1.0', ismanaged: false },
      { solutionid: 'sol-2', uniquename: 'msdyn_System', friendlyname: 'System', version: '1.0', ismanaged: true },
      { solutionid: 'sol-3', uniquename: 'Microsoft_Base', friendlyname: 'Base', version: '1.0', ismanaged: true },
      { solutionid: 'sol-4', uniquename: 'Active', friendlyname: 'Active', version: '1.0', ismanaged: true },
      { solutionid: 'sol-5', uniquename: 'Basic', friendlyname: 'Basic', version: '1.0', ismanaged: true },
      { solutionid: 'sol-6', uniquename: 'Default', friendlyname: 'Default', version: '1.0', ismanaged: true },
    ])
