...
export async function POST(request: NextRequest) {
  try {
    ...
    const customerTokenManager = gdapClient.getCustomerTokenManager(tenant.tenantId, partnerConfig);
    ...
    const preview = await diffService.previewDeployment(resolve(solutionPath), dataverseClient);
