...
describe('GET /api/environments', () => {
  ...
  it('should list environments in non-demo mode when configured', async () => {
    const { isDemoMode, getEffectiveIntegrationSettings, TokenManager, PowerPlatformAdminClient } = await import('@agentsync/core')
  ...
  it('should handle API errors gracefully', async () => {
    const { isDemoMode, getEffectiveIntegrationSettings, PowerPlatformAdminClient } = await import('@agentsync/core')
