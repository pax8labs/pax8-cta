        ...
        <div className="space-y-4">
          {!providers ? (
            <div className="text-center py-4">
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">Loading sign-in options...</p>
            </div>
          ) : (
        ...
        {providers && Object.values(providers).some(p => p.id === 'demo') && (
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-amber-800 dark:text-amber-200">Demo Mode Active</p>
