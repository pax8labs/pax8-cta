...
export default function WelcomePage() {
  ...
  if (view === "setup") {
    return (
      <div className="py-6">
        <SetupGuide onComplete={() => setView("welcome")} onSkip={() => setView("welcome")} />
      </div>
    );
  }
        ...
        <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border-2 border-blue-200 p-6 mb-8">
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-slate-900 mb-1">
                    Direct Import from Power Platform{" "}
                    <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full ml-2">
                      Recommended
                    </span>
                  </h3>
                  <p className="text-sm text-slate-600 mb-2">
                    Connect AgentSync to your Power Platform environment and import agents
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-slate-200 dark:border-slate-700">
              <div className="flex items-start gap-3">
                <span className="flex-shrink-0 w-6 h-6 bg-slate-400 dark:bg-slate-500 text-white rounded-full flex items-center justify-center text-sm font-bold">
                  2
                </span>
                <div className="flex-1">
                  ...
                  <details className="text-xs text-slate-500">
                    <summary className="cursor-pointer hover:text-slate-700 font-medium mb-1">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Upload a solution ZIP file from Copilot Studio, or connect to Power Platform and
                  import directly from your source environment.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Configure tenant-specific settings like connection references and environment
                  variables. Deploy to all selected tenants simultaneously with real-time progress
                  tracking.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">
                  Track deployment status across all tenants from a single dashboard. View logs,
                  retry failed deployments, and manage the agent lifecycle.
                </p>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="max-w-3xl mx-auto py-12">
      ...
      <div className="flex items-start justify-between mb-10">
        <div className="flex-1">
          ...
          <p className="text-base text-slate-600 dark:text-slate-400">
            Deploy and manage Copilot Studio agents across all your Microsoft 365 tenants from one
            place.
          </p>
        </div>
        <button
      ...
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 rounded-xl border-2 border-blue-200 dark:border-blue-800 p-6 mb-8">
              ...
              <div className="flex-1">
                ...
                <ol className="text-sm text-slate-600 dark:text-slate-400 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Enter credentials</strong> in AgentSync →{" "}
                      <a
                        href="/settings"
                        className="text-blue-600 dark:text-blue-400 underline hover:text-blue-700 dark:hover:text-blue-300"
                      >
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Test connection</strong> to verify everything works ✓
                    </span>
                  </li>
                </ol>
              </div>
              ...
              <div className="flex-1">
                ...
                <ol className="text-sm text-slate-600 dark:text-slate-400 space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Upload ZIP</strong> or import from source environment
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 dark:text-green-400 font-bold">b.</span>
                    <span>
                      <strong>Select target tenants</strong> (auto-discovered via GDAP)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 dark:text-green-400 font-bold">c.</span>
                    <span>
                      <strong>Click Deploy</strong> → deploys to all tenants simultaneously
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-600 dark:text-green-400 font-bold">d.</span>
                    <span>
                      <strong>Monitor progress</strong> with real-time updates
                    </span>
                  </li>
                </ol>
              </div>
        ...
        <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
          <p className="text-xs text-amber-800 dark:text-amber-300">
            ...
            . All other steps are done in AgentSync. Once setup is complete, deploying to 50 tenants
            takes the same time as deploying to 1!
          </p>
        </div>
      </div>
      ...
      {/* CLI Option */}
      <div className="mb-8 p-4 bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-950 dark:to-gray-900 rounded-lg border border-gray-700">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-white text-sm flex items-center gap-2">
                ...
                <span className="text-[10px] font-medium bg-green-600 text-white px-1.5 py-0.5 rounded">
                  NEW
                </span>
              </h3>
              <p className="text-xs text-gray-400">
                Use the CLI for automation. Press{" "}
                <kbd className="px-1 py-0.5 bg-gray-700 rounded text-[10px] font-mono">Cmd+K</kbd>{" "}
                to try it here, or install from{" "}
                <a
                  href="https://github.com/pax8labs/agentsync"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          <Link
            href="/?cli=open"
            className="px-4 py-2 bg-gray-700 text-green-400 font-medium rounded-lg hover:bg-gray-600 transition-colors text-sm font-mono"
          >
            Try CLI
          </Link>
        </div>
      ...
      <div className="bg-slate-50 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
        <h3 className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">
          What you can do with AgentSync:
        </h3>
