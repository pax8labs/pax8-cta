          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-white text-sm flex items-center gap-2">
                ...
                <span className="text-[10px] font-medium bg-green-600 text-white px-1.5 py-0.5 rounded">NEW</span>
              </h3>
              <p className="text-xs text-gray-400">
                Use the CLI for automation. Press <kbd className="px-1 py-0.5 bg-gray-700 rounded text-[10px] font-mono">Cmd+K</kbd> to try it here, or install from{' '}
                <a
