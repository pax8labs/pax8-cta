...
describe("Deployment Repository Integration Tests", () => {
  ...
  describe("createBatch", () => {
    ...
    it("should handle multiple batches", () => {
      ...
      const count = testDb.prepare("SELECT COUNT(*) as count FROM deployment_batches").get() as {
        count: number;
      };
  ...
  describe("getDeploymentsByTenant", () => {
    it("should retrieve all deployments for a tenant", () => {
      ...
      const deployment1 = insertDeployment(
        testDb,
        createTestDeployment({
          batchId: batch1.id,
          tenantId,
      ...
      const deployment2 = insertDeployment(
        testDb,
        createTestDeployment({
          batchId: batch2.id,
          tenantId,
  ...
  describe("listBatches", () => {
    ...
    it("should respect offset parameter", () => {
      const batch1 = insertDeploymentBatch(
        testDb,
        createTestDeploymentBatch({
          createdAt: "2026-01-01T00:00:00Z",
        })
      );
      const batch2 = insertDeploymentBatch(
        testDb,
        createTestDeploymentBatch({
          createdAt: "2026-01-02T00:00:00Z",
        })
      );
      const batch3 = insertDeploymentBatch(
        testDb,
        createTestDeploymentBatch({
