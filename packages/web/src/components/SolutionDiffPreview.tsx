        ...
        <div className="mt-4 grid grid-cols-2 gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
          <div>
            ...
            <p className="font-medium text-gray-900 dark:text-white">
              {diffData.solution.friendlyName}
            </p>
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-green-700 dark:text-green-400">{item.type}</p>
                    </div>
                  </div>
                </div>
              ))
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-blue-700 dark:text-blue-400">{item.type}</p>
                ...
                >
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-red-700 dark:text-red-400">{item.type}</p>
                    </div>
                  </div>
                </div>
              ))
