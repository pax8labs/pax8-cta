          ...
          if (node instanceof HTMLElement) {
            ...
            if (
              ...
              if (isHydrationError(text) || node.id?.includes('nextjs')) {
                console.log('[Demo Mode] Suppressing Next.js error overlay:', node.id || node.tagName)
    ...
    const removeExistingOverlays = () => {
      ...
      overlays.forEach((overlay) => {
        if (overlay instanceof HTMLElement) {
          console.log('[Demo Mode] Removing existing error overlay:', overlay.id || overlay.tagName)
