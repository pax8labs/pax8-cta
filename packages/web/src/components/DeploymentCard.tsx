...
export const DeploymentCard = React.memo(function DeploymentCard({
  ...
  const successRate =
    totalProcessed > 0 ? Math.round((deployment.completedTenants / totalProcessed) * 100) : 0;
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          <div className="flex items-center gap-3">
            <span className="font-semibold text-slate-900">{deployment.solutionName}</span>
        ...
        <div className="text-right flex-shrink-0 ml-4">
          ...
          <p className="text-xs text-slate-400 font-mono mt-1">{deployment.id.slice(0, 8)}</p>
        </div>
      </div>
