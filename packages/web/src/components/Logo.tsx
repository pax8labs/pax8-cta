export function Logo({ className = 'h-8 w-8' }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Modern sleek container - sync platform style */}
      <rect
        x="6"
        y="14"
        width="36"
      ...
      {/* Subtle container edge highlight */}
      <line x1="6" y1="44" x2="42" y2="44" stroke="#1e3a8a" strokeWidth="1" opacity="0.4" />

      {/* Gradient definitions */}
      <defs>
        <linearGradient id="containerGradient" x1="6" y1="14" x2="42" y2="44" gradientUnits="userSpaceOnUse">
