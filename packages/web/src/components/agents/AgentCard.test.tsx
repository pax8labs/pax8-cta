  ...
  describe('deployment info', () => {
    ...
    it('should show tenant count when deployed', () => {
      const agent = createMockAgent({
        totalDeployments: 5,
        deployedTenants: [
          { tenantId: 't1', tenantName: 'Tenant 1', version: '1.0.0', status: 'active', deployedAt: '2024-01-01' },
          { tenantId: 't2', tenantName: 'Tenant 2', version: '1.0.0', status: 'active', deployedAt: '2024-01-01' },
          { tenantId: 't3', tenantName: 'Tenant 3', version: '1.0.0', status: 'active', deployedAt: '2024-01-01' },
          { tenantId: 't4', tenantName: 'Tenant 4', version: '1.0.0', status: 'active', deployedAt: '2024-01-01' },
          { tenantId: 't5', tenantName: 'Tenant 5', version: '1.0.0', status: 'active', deployedAt: '2024-01-01' },
        ],
      })
      render(<AgentCard {...defaultProps} agent={agent} />)
    ...
    it('should show health percentage when tenants exist', () => {
      const agent = createMockAgent({
        ...
        deployedTenants: [
          ...
          { tenantId: 't2', tenantName: 'Tenant 2', version: '1.0.0', status: 'active', deployedAt: '2024-01-01' },
          { tenantId: 't3', tenantName: 'Tenant 3', version: '1.0.0', status: 'active', deployedAt: '2024-01-01' },
          { tenantId: 't4', tenantName: 'Tenant 4', version: '1.0.0', status: 'failed', deployedAt: '2024-01-01' },
        ],
      })
      render(<AgentCard {...defaultProps} agent={agent} />)
  ...
  describe('status change', () => {
    describe('active agent', () => {
      ...
      it('should show confirmation when Deprecate clicked', async () => {
        ...
        expect(screen.getByText('Deprecating will prevent new deployments but keep existing installations.')).toBeInTheDocument()
      })
