        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
          ...
          {currentStep === 'welcome' && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Let&apos;s connect AgentSync to your Microsoft Power Platform environment. This will enable you to:
              </p>
          ...
          {currentStep === 'credentials' && (
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Enter your Azure AD app registration details. These credentials will be encrypted and stored securely.
              </p>
          ...
          {currentStep === 'source' && (
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Optionally configure a source environment where your master agents/solutions are stored.
              </p>
              ...
              <div className="space-y-4">
                ...
                <label className="flex items-start p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  <input
                    ...
                    onChange={(e) => setForm({ ...form, connectionMappingEnabled: e.target.checked })}
                    className="mt-1 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                  />
                  <div className="ml-3">
                ...
                <label className="flex items-start p-4 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
                  <input
                    ...
                    onChange={(e) => setForm({ ...form, environmentVariablesEnabled: e.target.checked })}
                    className="mt-1 rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                  />
                  <div className="ml-3">
          ...
          {currentStep === 'test' && (
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Let&apos;s verify your configuration works correctly. Run the test below to activate the Continue button.
              </p>
          ...
          {currentStep === 'complete' && (
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                AgentSync is now connected to your Power Platform environment. You can start deploying agents to your customer tenants.
              </p>
