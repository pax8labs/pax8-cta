...
export const demoDeploymentsV2 = {
  ...
  get size() {
    return _demoDeploymentsV2.size;
  },
...
export const demoDeployedAgents = {
  ...
  get size() {
    return _demoDeployedAgents.size;
  },
...
export const demoTenantStatus = {
  ...
  get size() {
    return _demoTenantStatus.size;
  },
};

// Demo tags store
export const demoTags = new Set<string>(["enterprise", "smb", "priority", "pilot", "production"]);
