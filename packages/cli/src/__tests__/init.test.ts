...
describe('Init Command', () => {
  ...
  describe('production mode', () => {
    ...
    it('should show next steps after config creation', async () => {
      ...
      expect(containsText(output, 'Set your client secret')).toBe(true);
      expect(containsText(output, 'Add your tenant destinations')).toBe(true);
      expect(containsText(output, 'agentsync fleet inspect')).toBe(true);
