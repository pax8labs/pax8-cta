...
describe('Deployment Schema (v2)', () => {
  ...
  it('validates all deployment statuses', () => {
    const statuses = [
      'pending', 'scheduled', 'awaiting_approval', 'approved', 'rejected',
      'in_progress', 'completed', 'failed', 'cancelled', 'rolling_back', 'rolled_back'
    ];
